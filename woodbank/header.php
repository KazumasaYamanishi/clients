...
<div id="wrapper" class="clearfix">
	...
	<tr>
		<td class="sp-header-logo"><a href="<?php echo home_url(); ?>"><img style="max-width:98%;" src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt="WOOD BANK ウッドバンク"></a></td>
	...
	<a href="tel:0120-022-730" class="btn btn-tel btn-block"><small>ご遠慮なくお問い合わせください！</small><i class="fa fa-phone fa-fw" aria-hidden="true"></i>0120-022-730<small>受付 9:00～17:00(土日祝除く)</small></a>
	<?php else: ?>
	<div class="container">
...
<?php if(is_front_page() ):?>
	<p class="text-center">WOOD BANK ウッドバンクは海外生産40年。<br>こだわりの無垢材フローリングや羽目板などを<br>全国販売している無垢木材専門メーカー<br>フローリング 常時 3,000～5,000坪在庫</p>
<?php endif; ?>
<?php else: ?>
